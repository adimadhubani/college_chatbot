          ...
          <div className="p-4 border rounded-2xl bg-neutral-900/40 h-[480px] flex flex-col">
                  ...
                  {m.role === "assistant" && m.sources?.length ? (
                    <div className="mt-1 text-[11px] opacity-70">
                      Sources: {m.sources.map((s, j) => (
                        <span key={j} className="mr-2 underline">
                          {s.url ? (
            ...
            <div className="mt-3 flex gap-2">
              <input 
                ...
                className="flex-1 px-3 py-2 rounded-xl bg-neutral-800 outline-none" 
              />
              <button onClick={ask} className="px-4 py-2 rounded-xl border hover:bg-neutral-800">
                Send
              </button>
            </div>
          </div>
